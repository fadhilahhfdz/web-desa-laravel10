            ...
            <div class="single-slider" style="background-image:url('img/slider2.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
                                <h1>Selamat Datang Di <span>Desa Tengkil</span> Kecamatan <span>Sragen</span></h1>
                            ...
                            <div class="inner">
                                ...
                                <div class="single-content">
                                    ...
                                    <ul class="time-sidual">
                                        <li class="day">Senin s/d Kamis <span>07.30-16.00 WIB</span></li>
                                        <li class="day">Istirahat <span>12.00-13.00 WIB</span></li>
                                        <li class="day">Jum'at <span>07.15-14.30 WIB</span></li>
                                        <li class="day">Istirahat <span>11.30-12.30 WIB</span></li>
                                        <li class="day">Waktu Penyelesaian 5 s/d 15 Menit</li>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-schedule middle">
                            <div class="inner">
                                ...
                                <div class="single-content">
                                    <h4>Mobil Siaga</h4>
                                    <p>Layanan Mobil Siaga GRATIS Tidak dipungut Biaya untuk warga Masyarakat
                                        DesaTangkil</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-schedule last">
                            <div class="inner">
                                ...
                                <div class="single-content">
                                    ...
                                    <p>Desa Tangkil mendapatkan penghargaan sebagai Pelopor Desa Antikorupsi di
                                        Kabupaten Sragen, Jawa Tengah</p>
                                </div>
                            </div>
                        </div>
                    </div>
