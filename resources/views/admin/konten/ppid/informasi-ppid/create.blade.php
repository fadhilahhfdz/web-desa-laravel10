                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    Tambah Data Daftar Informasi PPID
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="/admin/ppid/informasi-ppid/create" method="POST">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <select name="daftar_informasi" id="daftar_informasi" class="form-control">
                                                ...
                                                <option value="Informasi Dikecualikan">Infomasi Dikecualikan</option>
                                            </select>
                                        </div>
