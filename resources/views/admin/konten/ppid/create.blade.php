                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="/admin/ppid/create" method="POST">
                                    @csrf
                                    <div class="d-flex justify-content-end">
                                        <a href="/admin/ppid" class="btn btn-sm btn-outline-secondary mx-2"><i
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" id="judul" name="judul" class="form-control" placeholder="Cth: PROFIL PPID" required>
                                        </div>
                                        <div class="form-group col-md-12">
