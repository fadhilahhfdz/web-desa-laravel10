...
class PelayananController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('user.konten.pelayanan', compact('pelayanan', 'dropdownPelayanan', 'dropdownProfil', 'waktuLayanan', 'informasiDesa', 'dropdownPpid', 'dropdownApbKonten', 'dropdownRpjmDes', 'dropdownRkpDes', 'sosmed'));
    }
