...
class PpidController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('user.konten.ppid', compact('ppid', 'dropdownPpid', 'dropdownProfil', 'dropdownPelayanan', 'waktuLayanan', 'informasiDesa', 'dropdownApbKonten', 'dropdownRpjmDes', 'dropdownRkpDes', 'sosmed'));
    }
